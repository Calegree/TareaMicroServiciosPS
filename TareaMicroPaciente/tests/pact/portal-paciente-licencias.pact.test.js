  ...
  describe('GET /licenses?patientId={id}', () => {
    describe('when patient has licenses', () => {
      ...
      it('should return patient licenses', async () => {
        const response = await axios.get('http://0.0.0.0:3002/licenses?patientId=11111111-1');
    ...
    describe('when patient has no licenses', () => {
      ...
      it('should return empty array', async () => {
        const response = await axios.get('http://0.0.0.0:3002/licenses?patientId=22222222-2');
